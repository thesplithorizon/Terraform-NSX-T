...
1. [Creation of multiple static routes using `.csv` file](#1-creation-of-multiple-static-routes) 
2. [Creation of multiple logical segments using `.csv` file](#2-creation-of-multiple-logical-segments)
